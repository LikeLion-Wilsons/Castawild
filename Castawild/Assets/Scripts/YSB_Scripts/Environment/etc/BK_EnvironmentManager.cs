...
namespace BKPureNature
{
    ...
    public class BK_EnvironmentManager : NetworkBehaviour
    {
        ...
        [Header("Weather Presets")][Space(5)]
        ...
        private void UpdateLighting()
        {
            ...
            // Cloud and water colors are now derived from the main light and fog
        ...
        private void UpdateCloudsVolume()
        {
            ...
            if (!cloudsMaterial.HasProperty("_ScatteringColor"))
            {
                ...
                // We don't return here anymore, to allow rendering even if color can't be set.
            }
            else
            {
